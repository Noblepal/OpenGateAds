            ...
            <div class="row">
                <div class="col-md-6 col-lg-6 col-xs-12">
                    <div class="about-wrapper">
                        ...
                        <p class="intro-desc">Open gate adverts space is a
                            Mobharvesters Website channel of all
                            advertisements. It is where clients
                            advertisements are properly
                            formatted to suit the original
                            imaginations in the artistic vision of
                            the customers. Open gate is a
                            flagship outage resource combine
                            harvester for Mobharvesters It is rooted
                            upon a firm foundation to ensure
                            consistent undisputable
                            marketing performance. It is where
                            Mobs of business minded persons
                            sow to reap from their seed plot
                            space provided here. The space
                            booked shall be treated as a SeedPlot
                            space which shall be displayed for a
                            period of 30 days or 360 days.
                        </p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-xs-12">
